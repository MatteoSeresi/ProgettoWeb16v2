...
<section id="autorizzazione">
    <button onclick="window.location.href='{{route('staff')}}'" class="back" title="Indietro"><i class="fa fa-arrow-left" aria-hidden="true"></i></button>
    <div class="log">
        <div class="log-head">
        ...
        <div class="log-form">
            ...
            {{ Form::open(array('route' => 'staffmodify', 'class' => 'contact-form')) }}           
                ...
                <div class="log-slot">
                    {{ Form::label('telefonno', 'Telefono', ['class' => 'label-input']) }}
