        ...
        <section id="azienda">
            <div id="question">
                ...
                <div class="d-flex justify-content-center align-items-center ">
                    ...
                    <a href="{{ route('eliminaFaq', ['faq_id' => $faq->id]) }}" title="Elimina Faq" class="btn-sm loader border-0 bg-black text-white p-3 text-center fw-bold text-uppercase d-block w-10 m-3 lh-1 rounded" onclick="event.preventDefault(); if (confirm('Sei sicuro di voler eliminare questa FAQ?')) { document.getElementById('delete-form-{{ $faq->id }}').submit(); }"> <i class="fa fa-trash"></i></a>
